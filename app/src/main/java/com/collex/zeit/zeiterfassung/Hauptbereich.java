...
public class Hauptbereich extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hauptbereich);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_krank) {

        } else if (id == R.id.nav_urlaub) {

        }
        else if (id == R.id.nav_sonder) {

        }
        else if (id == R.id.nav_mitteilungen) {
